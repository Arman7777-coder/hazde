            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Создать опцию для фильтра: {{ $filter->name }}</h4>
                                <p class="text-muted font-13"></p>

                                <form class="needs-validation" method="post" id="form" novalidate
                                      action="{{route('admin.categories.filters.options.store', [$filter->category_id, $filter->id])}}">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="inputName" name="name"
                                                   placeholder="Название опции" value="{{ old('name') }}" required>
                                            @error('name')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="inputValue" name="value"
                                                   placeholder="Значение опции" value="{{ old('value') }}" required>
                                            @error('value')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <button class="btn btn-primary mt-3" type="submit">Создать опцию</button>

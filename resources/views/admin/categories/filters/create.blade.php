            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Создать фильтр для категории: {{ $category->name }}</h4>
                                <p class="text-muted font-13"></p>

                                <form class="needs-validation" method="post" id="form" novalidate
                                      action="{{route('admin.categories.filters.store', $category->id)}}">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="inputName" name="name"
                                                   placeholder="Название фильтра" value="{{ old('name') }}" required>
                                            @error('name')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="inputTitle" name="title"
                                                   placeholder="Заголовок фильтра" value="{{ old('title') }}" required>
                                            @error('title')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" name="is_active" 
                                                       id="isActiveSwitch" value="1" {{ old('is_active', true) ? 'checked' : '' }}>
                                    ...
                                    <button class="btn btn-primary mt-3" type="submit">Создать фильтр</button>
                                    <a href="{{ route('admin.categories.filters.index', $category->id) }}" class="btn btn-secondary mt-3">Отмена</a>
                                </form>
                            </div> <!-- end card-body -->
                        </div> <!-- end card-->
                    </div> <!-- end col -->

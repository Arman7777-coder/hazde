...
class CheckAndSeedCategories extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'categories:check-and-seed';
     ...
     * @var string
     */
    protected $description = 'Check if categories exist and seed them if not';
    ...
    public function handle()
    {
        ...
        if (!File::exists($categoriesDir)) {
            ...
            $this->info('Created categories directory');
        }
        ...
        $this->info("Seeding complete. Created: $createdCount, Updated: $updatedCount");
        return 0;
    }
}